    ...
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-6">
        ...
        <div className="bg-gradient-to-r from-primaryGradientStart to-primaryGradientEnd dark:from-primaryGradientDarkStart dark:to-primaryGradientDarkEnd animate-background-pan bg-[length:200%_200%] rounded-3xl shadow-custom-lg-light dark:shadow-custom-lg-dark p-8 max-w-6xl w-full text-white relative overflow-auto max-h-[80vh]">
          ...
          {/* Title */}
          <h2 className="text-4xl font-bold mb-6 text-center">About Weatherly</h2>

          {/* Description paragraph */}
          <p className="mb-4 text-lg">
            Weatherly is a lightweight weather web app designed to give you accurate, real-time weather updates wherever you are. Whether you're planning your day or just want to check if you need an umbrella, Weatherly has you covered — simply, quickly, and beautifully.
          </p>
          ...
          <p className="mt-6 text-lg font-bold text-center">STAY UPDATED. STAY WEATHERLY.</p>
