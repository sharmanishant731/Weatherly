 ...
 * including temperature, wind speed, weather description, humidity, pressure, and cloudiness.
 ...
 */
function WeatherCard({ weather, unit, setUnit, windUnit, setWindUnit, convertTemp, convertWindSpeed }) {
  ...
  return (
    <div
      className="bg-gradient-to-r from-primaryGradientStart to-primaryGradientEnd dark:from-backgroundDarkStart dark:to-backgroundDarkEnd backdrop-blur-xl shadow-custom-lg-light dark:shadow-custom-lg-dark rounded-3xl p-8 max-w-5xl w-full text-white z-10 relative transform transition-transform duration-1000 hover:scale-110 hover:shadow-2xl animate-fade-in overflow-auto flex flex-row"
      aria-live="polite"
    >
        ...
        <div className="grid grid-cols-2 gap-x-12 gap-y-4">
          ...
          <div className="flex flex-col space-y-2">
            <p className="drop-shadow-lg text-lg whitespace-nowrap flex items-center">
              ...
              <span className="font-semibold" style={{ marginRight: '0.25rem' }}>Temperature:</span>{convertTemp(weather.main.temp).toFixed(1)} {tempUnitSymbol}
            </p>
